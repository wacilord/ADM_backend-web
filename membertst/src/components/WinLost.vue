      ...
      >
        ...
        <el-tab-pane label="游戏类型" name="game">
          ...
          >
            ...
            <el-table-column label="纯盈利" min-width="150">
              <template slot-scope="prop">
                <div style="text-align: right">
  ...
  methods: {
    ...
    requestManager(id) {
      ...
      if (this.accountLV == 1) {
        ...
        this.queryManagerParameters = this.queryParameters2;
        this.queryManagerParameters.pageIndex = 1;
        this.queryManagerParameters.agent = id;

        this.queryManagerParameters2 = this.queryParameters2;
        this.queryManagerParameters2.pageIndex = 1;
        this.queryManagerParameters2.agent = id;
    ...
    requestAgent(id) {
      ...
      this.queryAgentParameters = this.queryParameters2;
      this.queryAgentParameters.pageIndex = 1;
      this.queryAgentParameters.agent = id;

      this.queryAgentParameters2 = this.queryParameters2;
      this.queryAgentParameters2.pageIndex = 1;
      this.queryAgentParameters2.agent = id;
    ...
    queryForSummary() {
      ...
      this.queryParameters2.pageIndex = 1;
      this.queryParameters2.agent = null;
      this.onlyPlayer = false;
      this.isShowPlayerTab = false;
      this.isShowAgentTab = false;
      backendapiService.summaryreport(this.queryParameters2).then((res) => {
    ...
    queryForGame() {
      this.loading = true;
      backendapiService.gamesummaryreport(this.queryParameters2).then((res) => {
        if (res.data.statusCode != 200) {
          return;
        }
      ...
      this.gameRecords.unshift(
        {
          ...
          sumJackpot2: this.gameTotal.totalJackpot2,
          sumJackpot3: this.gameTotal.totalJackpot3,
          sumPureNetWin: this.gameTotal.totalPureNetWin,
        ...
        },
        {
          ...
          sumJackpot2: this.gameSubTotal.subTotalJackpot2,
          sumJackpot3: this.gameSubTotal.subTotalJackpot3,
          sumPureNetWin: this.gameSubTotal.subTotalPureNetWin,
      ...
      this.playerRecords.unshift(
        {
          ...
          sumJackpot2: this.playerTotal.totalJackpot2,
          sumJackpot3: this.playerTotal.totalJackpot3,
          sumPureNetWin: this.playerTotal.totalPureNetWin,
        ...
        },
        {
          ...
          sumJackpot2: this.playerSubTotal.subTotalJackpot2,
          sumJackpot3: this.playerSubTotal.subTotalJackpot3,
          sumPureNetWin: this.playerSubTotal.subTotalPureNetWin,
    ...
    queryForPlayer() {
      ...
      this.endQuery = false;
      backendapiService
        .playersummaryreport(this.queryParameters2)
        .then((res) => {
      ...
      let tempData = JSON.parse(JSON.stringify(this.queryParameters2));
      this.queryParameters.gameType = tempData.gameType;
      this.queryParameters.startDate = tempData.startDate;
      this.queryParameters.endDate = tempData.endDate;
    },

    childResetQuery(data) {
    ...
    clickPage(e) {
      ...
      this.queryParameters2.pageIndex = e.pageIndex;
      this.queryParameters.agent = null;
      this.queryParameters2.agent = null;
      this.queryForPlayer();
    },
    ...
    downloadReportByGame() {
      this.queryParameters.agent = null;
      backendapiService
        .summaryreportgamedownload(this.queryParameters2)
        .then((res) => {
    ...
    downloadReportByPlayer() {
      ...
      this.queryParameters.agent = null;
      backendapiService
        .summaryreportplayerdownload(this.queryParameters2)
        .then((res) => {
          const url = window.URL.createObjectURL(new Blob([res.data]));
          const link = document.createElement("a");
          link.href = url;
